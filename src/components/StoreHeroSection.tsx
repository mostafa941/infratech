...
function StoreHeroSection() {
  return (
    <div style={{background:"#E9E9E9"}} className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center pl-4 md:pl-12  ">
      ...
      {/* تم تغيير justify-center إلى justify-end ليتم محاذاة الصورة لأقصى اليمين */}
